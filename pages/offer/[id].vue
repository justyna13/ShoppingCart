...
const changeActiveTab = (tabId) => {
  productState.activeTab = tabId;
}

const changeSelectedSize = (size) => {
  if ((productState.soldOutSizes).includes(size)) return;

  productState.selectedSize = size;
}

const changeSelectedColor = (color) => {
  if ((productState.soldOutColors).includes(color)) return;
            ...
            <div class="left-col">
              <div class="thumbs">
                <a class="thumb-image active"
                   ...
                   data-index="0">
                  <span><img src="//cdn.shopify.com/s/files/1/1047/6452/products/product_150x150.png?v=1446769025"
                ...
                <a class="thumb-image"
                   ...
                   data-index="1">
                  <span><img src="//cdn.shopify.com/s/files/1/1047/6452/products/tricko1_150x150.jpg?v=1447104179"
                             alt="Tommy Hilfiger T-Shirt New York"></span>
                </a>
                <a class="thumb-image"
                   href="//cdn.shopify.com/s/files/1/1047/6452/products/tricko2_1024x1024.jpg?v=1447104180"
                   data-index="2">
                  <span><img src="//cdn.shopify.com/s/files/1/1047/6452/products/tricko2_150x150.jpg?v=1447104180"
                             alt="Tommy Hilfiger T-Shirt New York"></span>
                </a>
                <a class="thumb-image"
                   href="//cdn.shopify.com/s/files/1/1047/6452/products/tricko3_1024x1024.jpg?v=1447104182"
                   data-index="3">
                  <span><img src="//cdn.shopify.com/s/files/1/1047/6452/products/tricko3_150x150.jpg?v=1447104182"
                             alt="Tommy Hilfiger T-Shirt New York"></span>
                </a>
              </div>
              <div class="big">
                <span id="big-image" class="img" quickbeam="image"
                      style="background-image: url('//cdn.shopify.com/s/files/1/1047/6452/products/product_1024x1024.png?v=1446769025')"
                      data-src="//cdn.shopify.com/s/files/1/1047/6452/products/product_1024x1024.png?v=1446769025"></span>
              ...
              <div itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                ...
                <div class="swatches">
                  <div class="swatch clearfix" data-option-index="0">
                    ...
                    <div
                      v-for="(size, index) in productState.availableSizes"
                      class="swatch-element plain m available"
                      @click="() => changeSelectedSize(size)"
                      :class="{'soldout': (productState.soldOutSizes).includes(size)}"
                    >
                      <input
                        :id="'product-' + size"
                        type="radio"
                        :name="'size-option-' + index"
                        :value="size"
                        :checked="(productState.selectedSize === size)"/>
                  ...
                  <div class="swatch clearfix" data-option-index="1">
                    ...
                    <div
                      v-for="(color, index) in productState.availableColors"
                      class="swatch-element color available"
                      @click="() => changeSelectedColor(color)"
                      :class="[color, {'soldout': (productState.soldOutColors).includes(color)}]">
                      <div class="tooltip">{{ color.toLowerCase() }}</div>
                      <input
                        type="radio"
                        @change="productState.selectedColor = color"
                        :name="'color-option-' + index"
                        :value="color"
                        :checked="(productState.selectedColor === color)"/>
                      <label :for="'swatch-1-' + color" :style="{borderColor: color}">
                        <img class="crossed-out"
                             src="//cdn.shopify.com/s/files/1/1047/6452/t/1/assets/soldout.png?10994296540668815886"/>
                ...
                <div class="tabs">
                  <div class="tab-labels">
                    <span
                      ...
                      :class="{'active' : (productState.activeTab === 1)}">
                      Info
                    </span>
                    <span
                      @click="() => changeActiveTab(2)"
                      :class="{'active' : (productState.activeTab === 2)}">
                      Brand
                    </span>
                  </div>
                  <div class="tab-slides">
                    <div
                      class="slide"
                      :class="{'active' : (productState.activeTab === 1)}">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. A consequuntur deleniti dolorem
                      doloremque ducimus, eveniet explicabo natus necessitatibus nemo nobis perferendis totam veritatis
                      voluptas. Animi blanditiis hic itaque laborum necessitatibus!
                    </div>
                    <div class="slide" :class="{'active' : (productState.activeTab === 2)}">
                      Tony Hunfinger
                    </div>
                  </div>
                </div>
      ...
      <aside class="related">
        <div class="_cont">
          ...
          <div class="collection-list cols-4" id="collection-list" data-products-per-page="4">
            ...
            <span class="img">
              <span
                style="background-image: url('//cdn.shopify.com/s/files/1/1047/6452/products/tricko1_70d2887b-ec6a-4bcb-a93b-7fd1783e6445_grande.jpg?v=1447530130')"
                class="i first"></span>
              <span class="i second"
                    style="background-image: url('//cdn.shopify.com/s/files/1/1047/6452/products/product_030f9fc5-f253-4dca-a43a-fe2b719d0704_grande.png?v=1447530130')"></span>
            </span>
              <span class="text">
            ...
            <span class="img">
              <span
                style="background-image: url('//cdn.shopify.com/s/files/1/1047/6452/products/tricko2_357767df-d7ff-4b58-b705-edde76bb32b7_grande.jpg?v=1447530150')"
                class="i first"></span>
              <span class="i second"
                    style="background-image: url('//cdn.shopify.com/s/files/1/1047/6452/products/tricko1_613d5776-ea61-4f9b-abef-0ce847c63a67_grande.jpg?v=1447530150')"></span>
            </span>
              <span class="text">
            ...
            <span class="img">
              <span
                style="background-image: url('//cdn.shopify.com/s/files/1/1047/6452/products/tricko3_0e98498a-123c-4305-9d94-d8280bb46416_grande.jpg?v=1447530164')"
                class="i first"></span>
              <span class="i second"
                    style="background-image: url('//cdn.shopify.com/s/files/1/1047/6452/products/tricko2_6c949188-dba0-4789-9434-c0821b92f3f4_grande.jpg?v=1447530164')"></span>
            </span>
              <span class="text">
            ...
            <span class="img">
              <span
                style="background-image: url('//cdn.shopify.com/s/files/1/1047/6452/products/product_7d606126-1b60-4738-99b3-062810f2db8b_grande.png?v=1447530674')"
                class="i first"></span>
              <span class="i second"
                    style="background-image: url('//cdn.shopify.com/s/files/1/1047/6452/products/tricko3_fd08d231-654c-4304-81b2-9191e6fd141e_grande.jpg?v=1447530674')"></span>
            </span>
              <span class="text">
            ...
            <span class="img">
              <span
                style="background-image: url('//cdn.shopify.com/s/files/1/1047/6452/products/tricko1_bba77d82-7f85-47af-9a45-f4700bcc04ad_grande.jpg?v=1447530689')"
                class="i first"></span>
              <span class="i second"
                    style="background-image: url('//cdn.shopify.com/s/files/1/1047/6452/products/product_f065e961-d296-48a8-8a67-a3532200e257_grande.png?v=1447530689')"></span>
            </span>
              <span class="text">
            ...
            <span class="img">
              <span
                style="background-image: url('//cdn.shopify.com/s/files/1/1047/6452/products/tricko2_bf59c7f2-7c1f-4822-9494-6a984598a56c_grande.jpg?v=1447530706')"
                class="i first"></span>
              <span class="i second"
                    style="background-image: url('//cdn.shopify.com/s/files/1/1047/6452/products/tricko1_c6fa0fc1-99a0-4bd0-a1d8-0270127977fc_grande.jpg?v=1447530706')"></span>
            </span>
              <span class="text">
