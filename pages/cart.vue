  ...
  <div class="page-content cart-page">
    <div class="container">
      ...
      <div class="shopping-cart">
        ...
        <div v-for="(product, i) in []" class="product">
          ...
          <div class="product-quantity">
            <input type="number" v-model="product.quantity" min="1" @change="updateQuantity">
          </div>
          ...
          <div class="product-line-price">{{ productsPrices[i] }}</div>
        </div>
